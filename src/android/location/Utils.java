...
public class Utils {
    ...
    public static Intent getBaiduOpenUri(String lat, String lng) {
        String baidu = String.format("baidumap://map/geocoder?location=%s,%s&coord_type=gcj02&src=andr.baidu.openAPIdemo", lat, lng);
        Intent intent = new Intent();
        intent.setData(Uri.parse(baidu));
        return intent;
    }

    public static Intent getBaiduOpenUrl(String lat, String lng) {
        Uri uri = Uri.parse(String.format("http://api.map.baidu.com/geocoder?location=%s,%s&coord_type=gcj02&output=html&src=webapp.baidu.openAPIdemo", lat, lng));
